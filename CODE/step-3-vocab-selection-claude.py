# Step 3: Vocabulary term selection using Anthropic's Claude models
...
class VocabularySelector:
    """Class to select the best vocabulary terms for each drawing using Claude."""
...
"""
    ...
    def select_vocabulary_terms(self, entry_data: Dict[str, Any]) -> Tuple[Dict[str, Any], str, Any, float]:
        """Select vocabulary terms for a single entry using Claude."""
...
class ArchitecturalDrawingsVocabularyProcessor:
    ...
    def run(self) -> bool:
        ...
        print(f"\nARCHITECTURAL DRAWINGS STEP 3 - VOCABULARY SELECTION (Claude)")
        ...
        create_token_usage_log(
            logs_folder_path=logs_folder_path,
            script_name="architectural_drawings_vocabulary_selection_claude",
            model_name=self.model_name,
        ...
        print("\n" + "=" * 50)
        print(f"STEP 3 COMPLETE (Claude)")
