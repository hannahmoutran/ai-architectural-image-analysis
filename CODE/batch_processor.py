...
for large-scale architectural drawing metadata processing.
"""
...
class BatchProcessor:
    ...
    def create_batch_requests(self, requests_data: List[Dict[str, Any]],
        ...
        """
        Convert request data into OpenAI batch format for Responses API.
        ...
        for i, req_data in enumerate(requests_data):
            ...
            if "text" in req_data:
                batch_request["body"]["text"] = req_data["text"]
    ...
    def process_batch_results(self, results: List[Dict[str, Any]],
        ...
        Args:
            results: Raw batch results from OpenAI Responses API
        ...
        for result in results:
            ...
            if "response" in result and result["response"]:
                ...
                if "output" in body and body["output"]:
                    # Extract the content from output_text or concatenate output items
